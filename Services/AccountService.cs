...
namespace SongAppApi.Services
{
    ...
    public interface IAccountService
    {
        ...
        void Register(Models.Accounts.RegisterRequest model, string origin);
    ...
    public class AccountService : IAccountService
    {
        ...
        public void Register(Models.Accounts.RegisterRequest model, string origin)
        {
            // validate
        ...
        public void ResetPassword(Models.Accounts.ResetPasswordRequest model)
        {
        ...
        //todo replace the static messages with params so that they can be instead
        ...
        private void sendVerificationEmail(Account account, string origin)
        {
            ...
            if (!string.IsNullOrEmpty(origin))
            {
                ...
                //todo : REMOVE THE ORIGIN PARAM AND INSTEAD HARDCODE IT FOR SECURITY
